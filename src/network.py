...
class Perceptron:
    ...
    def __init__(self, weights: Sequence[float], bias: float):
        ...
        assert all(isinstance(weight, float) or isinstance(weight, int) for weight in weights)
...
class MultiLayerPerceptron:
    ...
    def __init__(self, input_size: int, hidden_layers: Sequence[HiddenLayer], output_layer: SoftmaxLayer):
