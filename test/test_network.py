...
def test_can_create_network() -> None:
    ...
    result = network.predict(array([1, 2]))
...
def test_can_create_network_with_premade_neurons() -> None:
    ...
    result = network.predict(array([1, 1]))
